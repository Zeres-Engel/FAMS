...
class PyTableWidget(QTableWidget):
    def __init__(
        ...
        # Vô hiệu hóa timer để không tự động đọc file CSV nữa
        # self.timer = QTimer()
    ...
    def update_from_csv(self):
        """
        Chức năng này đã bị vô hiệu hóa vì không còn sử dụng trong ứng dụng mới.
        """
        # Đã comment để tránh lỗi khi không tìm thấy file CSV
